...
@section('content')
    ...
    <div class="document-part client-part">
        ...
        <div class="company-header" style="margin-bottom: 2mm; padding-bottom: 2mm; border-bottom: 0.5px solid #000; width: 100%; max-width: 100%; box-sizing: border-box;">
            <div style="overflow: hidden; width: 100%;">
                <div style="float: left; width: 60%; max-width: 60%; box-sizing: border-box;">
                    ...
                    @endphp
                    @if($logoExists)
                    <img src="{{ $logoPath }}" alt="Logo" style="max-height: 12mm; max-width: 35mm; margin-bottom: 0.5mm; display: block;">
                    @endif
                    @if($data->companyName)
                    <div style="font-size: 5px; font-weight: bold; margin-bottom: 0.5mm; letter-spacing: 0.2px;">{{ $data->companyName }}</div>
                    @endif
                    @if($data->companyLegalName)
                    <div style="font-size: 4px; margin-bottom: 0.5mm; line-height: 1.3; color: #333;">{{ $data->companyLegalName }}</div>
                    @endif
                ...
                <div style="float: right; width: 38%; max-width: 38%; text-align: right; font-size: 4px; box-sizing: border-box;">
            ...
            <table class="table" style="width: 100%; max-width: 100%; table-layout: fixed;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="font-size: 4px; padding: 0.5px;">{{ number_format($work['price'], 2, ',', ' ') }} ₽</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        <td class="text-right" colspan="1" style="font-weight: bold; font-size: 4px; padding: 0.5px;">Итого:</td>
            ...
            <table class="table" style="width: 100%; max-width: 100%; table-layout: fixed;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="font-size: 4px; padding: 0.5px;">{{ $material['quantity'] }}</td>
                        <td class="text-right" style="font-size: 4px; padding: 0.5px;">{{ number_format($material['price'], 2, ',', ' ') }} ₽</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        <td class="text-right" colspan="2" style="font-weight: bold; font-size: 4px; padding: 0.5px;">Итого:</td>
                        <td class="text-right" style="font-weight: bold; font-size: 4px; padding: 0.5px;">
        ...
        <div class="section">
            ...
            <div class="info-row">
                ...
                <div class="info-value" style="font-weight: bold; font-size: 7px;">
                    {{ number_format($data->actualPrice, 2, ',', ' ') }} ₽
                </div>
            </div>
            @endif
        </div>
        ...
        <div class="signature-section">
            <div style="float: left; width: 48%; margin-right: 4%;">
                <div style="text-align: center; font-size: 5px; font-weight: bold; margin-bottom: 0.8mm; letter-spacing: 0.2px;">Менеджер:</div>
                <div style="text-align: center; font-size: 4px; margin-bottom: 1.5mm; color: #333;">{{ $data->managerName ?? '_________________' }}</div>
                <div style="margin-top: 10mm; text-align: center; font-size: 5px; border-top: 0.5px solid #000; padding-top: 1mm;">_________________</div>
                <div style="text-align: center; font-size: 4px; margin-top: 0.5mm; color: #666;">(подпись)</div>
            </div>
            <div style="float: left; width: 48%;">
                <div style="text-align: center; font-size: 5px; font-weight: bold; margin-bottom: 0.8mm; letter-spacing: 0.2px;">Клиент:</div>
                <div style="text-align: center; font-size: 4px; margin-bottom: 1.5mm; color: #333;">{{ $data->clientName }}</div>
                <div style="margin-top: 10mm; text-align: center; font-size: 5px; border-top: 0.5px solid #000; padding-top: 1mm;">_________________</div>
                <div style="text-align: center; font-size: 4px; margin-top: 0.5mm; color: #666;">(подпись)</div>
            </div>
            <div style="clear: both;"></div>
