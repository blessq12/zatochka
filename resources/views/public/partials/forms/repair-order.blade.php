@php
    /** @var list<array{value: string, label: string}> $equipmentTypes */
...
<section class="bg-white dark:bg-dark-blue-500 py-12 sm:py-16 lg:py-20">
    <div class="max-w-2xl mx-auto px-8 sm:px-12 lg:px-16 xl:px-20">
        ...
        <form data-public-order-form data-service-type="repair" class="space-y-6">
            ...
            <div>
                ...
                <input name="device_name" type="text" required class="{{ $inputClass }}" placeholder="Например, фен Dyson">
            </div>
            ...
            <div>
                ...
                <select name="equipment_type" required class="{{ $inputClass }}">
            ...
            <div>
                ...
                <textarea name="problem_description" rows="4" required class="{{ $inputClass }}" placeholder="Опишите неисправность"></textarea>
            </div>

            <div>
                <span class="block text-base font-jost-medium text-dark-gray-500 dark:text-gray-200 mb-2">Срочность</span>
                <div class="flex flex-col sm:flex-row gap-3">
                    <label class="flex items-center gap-2"><input type="radio" name="urgency_type" value="standard" checked> Стандартный</label>
                    <label class="flex items-center gap-2"><input type="radio" name="urgency_type" value="urgent"> Срочный</label>
                </div>
            </div>

            <div class="flex items-center gap-3">
                <input name="needs_delivery" type="checkbox" id="repair_needs_delivery" checked class="w-5 h-5">
                <label for="repair_needs_delivery" class="text-base font-jost-medium text-dark-gray-500 dark:text-gray-200">
                    Нужна доставка
                </label>
            </div>
            ...
            <div>
                ...
                <input name="name" type="text" required class="{{ $inputClass }}">
            </div>
            ...
            <div>
                ...
                <input name="phone" type="tel" required class="{{ $inputClass }}">
            </div>

            <div>
                <label class="block text-base font-jost-medium text-dark-gray-500 dark:text-gray-200 mb-2">Комментарий</label>
                <textarea name="comment" rows="3" class="{{ $inputClass }}"></textarea>
            </div>
