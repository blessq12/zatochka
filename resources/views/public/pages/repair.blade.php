...
@section('meta_description', 'Прайс и заказ ремонта beauty-оборудования. Заточка.ТСК, Томск.')

@section('vite')
    @vite(['resources/js/islands/repair-form.js'])
@endsection
...
<div class="min-h-screen bg-white dark:bg-dark-blue-500">
    @include('public.partials.page-hero', ['title' => 'ПРАЙС НА РЕМОНТ'])
