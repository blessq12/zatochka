...
<template>
    <div class="min-h-screen bg-white dark:bg-dark-blue-500">
        ...
        <!-- Секция заголовка "При ремонте чистка в подарок" -->
        <section class="bg-white dark:bg-dark-blue-500 py-8 sm:py-12 lg:py-16">
            <div
        ...
        <section class="bg-white dark:bg-dark-blue-500 py-12 sm:py-16 lg:py-20">
            ...
            >
                ...
                <h2
                    class="text-3xl sm:text-4xl font-jost-bold text-dark-blue-500 dark:text-dark-blue-300 text-center pt-8"
                >
