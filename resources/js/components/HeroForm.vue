...
<template>
    <!-- <h2 class="section-title text-3xl font-bold text-start mb-4">
        {{ header }}
    </h2>
    <p class="text-gray-600 text-start mb-4 text-lg">{{ description }}</p> -->
    <div class="rounded-2xl shadow-lg p-6">
        <form class="space-y-4" @submit.prevent="submitForm">
            ...
            <div v-if="currentStep === 1" class="animate-fade-up">
                ...
                >
                    <button
                        ...
                        :key="type.id"
                        type="button"
                        class="p-3 border-2 rounded-lg text-center hover:bg-accent/5 transition-all"
                        :class="
                ...
                <div v-if="selectedToolType" class="mt-4">
                    <h3 class="text-lg font-bold mb-3">Выберите подтип:</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <button
                            v-for="subType in selectedToolType.subTypes"
                            :key="subType"
                            type="button"
                            class="p-2 border-2 rounded-lg text-center hover:bg-accent/5 transition-all"
                            :class="
            ...
            <div v-if="currentStep === 2" class="animate-fade-up">
                <h3 class="text-lg font-bold mb-3">Укажите детали:</h3>
            ...
            <div v-if="currentStep === 3" class="animate-fade-up">
                <h3 class="text-lg font-bold mb-3">Контактная информация:</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-group">
