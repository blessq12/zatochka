...
export default {
    ...
    computed: {
        ...
        ...mapState(useBootstrapStore, ["socialLinks"]),
        logoColor() {
...
<template>
    ...
    <transition name="mobile-menu">
        ...
        >
            ...
            <div class="relative pb-4 mt-auto">
                <div
                    class="absolute bottom-0 left-1/2 -translate-x-1/2 w-[120%] h-[120px] bg-white rounded-t-full"
                    style="border-radius: 50% 50% 0 0 / 100% 100% 0 0"
                ></div>

                <div class="relative px-6 z-10 pt-4 pb-2">
                    <!-- Иконки инструментов -->
                    ...
                    <div
                        ...
                        class="flex justify-center items-center gap-3 flex-wrap"
                    >
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            class="px-3 py-2 bg-[#003859] text-white text-xs font-jost-bold rounded-full hover:scale-105 transition-transform duration-300"
