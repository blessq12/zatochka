...
use App\Application\Finance\Port\OrderPricingGatePort;
use App\Application\Finance\Port\OrderSettlementPort;
use App\Application\Finance\Port\PerformedWorkRefPort;
...
use App\Domain\CRM\Repository\ManagerRepository as CrmManagerRepository;
use App\Domain\CRM\Repository\MasterRepository as CrmMasterRepository;
...
use App\Infrastructure\CRM\ReadModel\EloquentEquipmentReadModel;
use App\Infrastructure\CRM\Repository\EloquentClientEquipmentRepository;
use App\Infrastructure\Finance\Listener\ClearWorkPriceOnPerformedWorkRemoved;
use App\Infrastructure\Finance\Listener\ClearWorkPricesOnOrderCancelled;
use App\Infrastructure\Finance\Listener\ClearWorkPricesOnOrderReturnedToMaster;
...
use App\Infrastructure\Finance\Port\EloquentOrderPricingGatePort;
use App\Infrastructure\Finance\Port\EloquentOrderSettlementPort;
use App\Infrastructure\Finance\Port\EloquentPerformedWorkRefPort;
...
use App\Infrastructure\Finance\ReadModel\EloquentWorkPriceReadModel;
...
use App\Infrastructure\Finance\Repository\EloquentWorkPriceRepository;
use App\Infrastructure\CRM\ReadModel\EloquentStaffDirectoryReadModel;
use App\Infrastructure\CRM\Repository\EloquentManagerRepository as EloquentCrmManagerRepository;
use App\Infrastructure\CRM\Repository\EloquentMasterRepository as EloquentCrmMasterRepository;
use App\Infrastructure\Identity\Listener\ProvisionClientAccountOnPortalSignUp;
use App\Infrastructure\Identity\Listener\ProvisionManagerAccountOnManagerRegistered;
use App\Infrastructure\Identity\Listener\ProvisionMasterAccountOnMasterRegistered;
use App\Infrastructure\Identity\Listener\SyncManagerAccountEmailOnManagerUpdated;
use App\Infrastructure\Identity\Listener\SyncMasterAccountEmailOnMasterUpdated;
use App\Infrastructure\Identity\ReadModel\EloquentStaffPersonReadModel;
use App\Infrastructure\Identity\Repository\EloquentClientAccountRepository;
use App\Infrastructure\Identity\Repository\EloquentManagerAccountRepository;
use App\Infrastructure\Identity\Repository\EloquentMasterAccountRepository;
...
use App\Infrastructure\Order\ReadModel\EloquentReviewReadModel;
use App\Infrastructure\Order\Repository\EloquentOrderRepository;
use App\Infrastructure\Order\Repository\EloquentReviewRepository;
use App\Infrastructure\Order\Pdf\DompdfPdfRenderer;
use App\Infrastructure\Order\Read\EloquentCompanyDocumentReadModel;
use App\Infrastructure\Order\Read\EloquentOrderDocumentReadModel;
use App\Infrastructure\Order\Repository\EloquentDocumentTemplateRepository;
use App\Infrastructure\SiteContent\Repository\EloquentLegalDocumentRepository;
...
final class PersistenceServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(CrmManagerRepository::class, EloquentCrmManagerRepository::class);
        $this->app->bind(CrmMasterRepository::class, EloquentCrmMasterRepository::class);
        $this->app->bind(StaffDirectoryReadPort::class, EloquentStaffDirectoryReadModel::class);
        $this->app->bind(ClientAccountRepository::class, EloquentClientAccountRepository::class);
        $this->app->bind(ManagerAccountRepository::class, EloquentManagerAccountRepository::class);
        $this->app->bind(MasterAccountRepository::class, EloquentMasterAccountRepository::class);
        ...
        $this->app->bind(StaffPersonReadPort::class, EloquentStaffPersonReadModel::class);
        ...
        $this->app->bind(LegalDocumentRepository::class, EloquentLegalDocumentRepository::class);
    ...
    public function boot(): void
    {
        ...
        Event::listen(ManagerAccountProvisioningRequested::class, ProvisionManagerAccountOnManagerRegistered::class);
        Event::listen(MasterAccountProvisioningRequested::class, ProvisionMasterAccountOnMasterRegistered::class);
        Event::listen(ManagerUpdated::class, SyncManagerAccountEmailOnManagerUpdated::class);
        Event::listen(MasterUpdated::class, SyncMasterAccountEmailOnMasterUpdated::class);
    }
}
