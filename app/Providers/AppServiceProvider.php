...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(\App\Domain\Company\Mapper\BranchMapper::class, \App\Infrastructure\Company\Mapper\BranchMapperImpl::class);
        ...
        $this->app->singleton(\App\Domain\Company\Repository\BranchRepository::class, \App\Infrastructure\Company\Repository\BranchRepositoryImpl::class);
