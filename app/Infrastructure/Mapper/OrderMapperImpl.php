...
class OrderMapperImpl implements OrderMapper
{
    public function toDomain($eloquentModel): Order
    {
        ...
        return new Order(
            ...
            internalNotes: $eloquentModel->internal_notes,
            problemDescription: $eloquentModel->problem_description,
    ...
    public function toEloquent(Order $domainEntity): array
    {
        return [
            ...
            'internal_notes' => $domainEntity->getInternalNotes(),
            'problem_description' => $domainEntity->getProblemDescription(),
