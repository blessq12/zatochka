...
final class DocumentTemplateVariableCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'order.price', 'label' => 'Стоимость', 'description' => 'Предварительная стоимость'],
            ...
            ['key' => 'branch.name', 'label' => 'Филиал', 'description' => 'Название точки (из компании)'],
            ['key' => 'branch.address', 'label' => 'Адрес филиала', 'description' => 'Адрес из контактов'],
            ['key' => 'branch.phone', 'label' => 'Телефон филиала', 'description' => 'Телефон из контактов'],
            ...
            ['key' => 'company.header', 'label' => 'Реквизиты компании', 'description' => 'Блок реквизитов'],
