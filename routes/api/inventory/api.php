...
Route::prefix('stock-items')->middleware(['auth:sanctum', 'staff'])->group(function (): void {
    Route::get('/', [StockItemController::class, 'index']);
    Route::get('{stockItemId}', [StockItemController::class, 'show']);
});

Route::prefix('stock-items')->middleware(['auth:sanctum', 'manager'])->group(function (): void {
